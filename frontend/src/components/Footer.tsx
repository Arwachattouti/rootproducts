    ...
    <footer className="bg-[#373E02] text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-12">
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-bold text-[#C8AD7F] uppercase tracking-wider">
              Contact
            </h3>
            <ul className="space-y-3 ">
              ...
              <li className="flex items-center group">
                ...
                <a href="tel:+21625459912" className="hover:text-white transition-colors">+216 25 459 912</a>
              </li>
              <li className="flex items-center group">
                <Mail className="h-5 w-5 mr-3 text-[#C8AD7F] shrink-0 group-hover:scale-110 transition-transform" />
                <a href="mailto:contact@rootproducts.tn" className="hover:text-white transition-colors break-all">
          ...
          <div>
            <h3 className="text-lg font-bold text-[#C8AD7F] uppercase tracking-wider mb-4">
              Navigation
            </h3>
            <ul className="space-y-2">
              {[
                ...
                <li key={link.path}>
                  <Link 
                    to={link.path} 
                    className=" hover:text-white hover:translate-x-1 transition-all duration-200 flex items-center"
                  >
                    <span className="mr-2 opacity-0 -ml-4 group-hover:opacity-100 transition-all">›</span>
                    {link.name}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <p className="text-sm mb-4 italic">Rejoignez notre communauté engagée.</p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link to="/legal" className="hover:text-[#C8AD7F] transition-colors underline-offset-4 hover:underline">
                  Mentions légales
                </Link>
              </li>
              <li>
                <Link to="/privacy" className="hover:text-[#C8AD7F] transition-colors underline-offset-4 hover:underline">
                  Politique de confidentialité
                </Link>
              </li>
              <li>
                <Link to="/terms" className="hover:text-[#C8AD7F] transition-colors underline-offset-4 hover:underline">
                  CGV
                </Link>
              </li>
            </ul>
      ...
      <div className="py-8 px-4 text-center bg-[#2e3402]">
        <p className="text-xs sm:text-sm text-gray-400">
          © {currentYear} <span className="text-[#C8AD7F] font-semibold">ROOT Products</span>. 
