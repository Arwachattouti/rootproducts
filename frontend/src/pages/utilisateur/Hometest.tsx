        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-16">
            ...
            <div className="lg:w-1/3">
              ...
              <div className="h-1 w-12 sm:w-16 md:w-20 bg-[#357A32]" />
              <p
                className="
            ...
            <div className="lg:w-2/3 space-y-4 sm:space-y-6 md:space-y-8">

              <p className="font-seasons text-sm sm:text-base md:text-xl lg:text-2xl leading-relaxed">
          ...
          >
            ...
            >
              <Award
                className="
                  ...
                  text-yellow-600 mx-auto mb-3 sm:mb-4
                "
              />
              <h3
                className="
              ...
              <p
                ...
                "
              >
                Soutenir les petits agriculteurs pour offrir des
            ...
            >
              <Leaf
                className="
                  h-8 w-8 sm:h-10 sm:w-10
                  text-green-700 mx-auto mb-3 sm:mb-4
                "
              />
              <h3
                className="
              ...
              <p
                ...
                "
              >
                Une agriculture respectueuse pour un impact positif sur
            ...
            >
              <Users
                className="
                  h-8 w-8 sm:h-10 sm:w-10
                  text-blue-600 mx-auto mb-3 sm:mb-4
                "
              />
              <h3
                className="
              ...
              <p
                ...
                "
              >
                Valoriser le travail local et contribuer au
                développement du terroir tunisien.
              </p>
            </div>
            ...
            >
              <Eye
                className="
                  h-8 w-8 sm:h-10 sm:w-10
                  text-purple-600 mx-auto mb-3 sm:mb-4
                "
              />
              <h3
                className="
              ...
              <p
                ...
                "
              >
                Un processus clair et responsable de la terre jusqu'à
                votre table.
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div className="bg-white p-5 sm:p-6 md:p-8 rounded-xl shadow-lg">
              ...
              <p className="font-seasons text-xs sm:text-sm md:text-base lg:text-xl text-gray-700">
                "La meilleure mloukhia que j'ai goûtée depuis longtemps !
                Le goût est authentique et la qualité irréprochable."
              </p>
            </div>
            ...
            <div className="bg-white p-5 sm:p-6 md:p-8 rounded-xl shadow-lg">
              ...
              <p className="font-seasons text-xs sm:text-sm md:text-base lg:text-xl text-gray-700">
                "Livraison rapide et emballage soigné. J'ai commandé le
                coffret découverte, excellent rapport qualité-prix."
              </p>
            </div>
            ...
            <div className="bg-white p-5 sm:p-6 md:p-8 rounded-xl shadow-lg">
              ...
              <p className="font-seasons text-xs sm:text-sm md:text-base lg:text-xl text-gray-700">
                "Mes enfants adorent ! Enfin une mloukhia de qualité
                premium accessible."
              </p>
            </div>
          </div>
